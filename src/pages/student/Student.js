...
const Student = ({Children}) => {
    ...
    <>
    <div className='conf'>
      <div style={{width:open ? "300px" :"50px"}} className='Sidebar1 '>
        <div className='top-section'>
          <h1 style={{display:open ? "block" :"none"}} className='logo'><p className='text-white'>Student</p></h1>
          <div style={{marginLeft:open ? "50px" :"10px"}} className='bars'>
