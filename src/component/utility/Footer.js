...
import { BsLinkedin, BsYoutube, BsInstagram, BsGithub, BsFacebook, BsTwitter } from "react-icons/bs"
      ...
      <footer className='py-3 footer2'>
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-6 d-flex  align-items-center gap-30'>
              <div className='social_icons d-flex flex-wrap gap-30'>
